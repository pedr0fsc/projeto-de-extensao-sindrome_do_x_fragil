...
import { ModalCadastrarPaciente } from "../../components/modal-pacientes";
import { ModalConsultarPacientes } from "../../components/modal-consultar-pacientes";
...
import { useAlerta } from "../../components/alerta";
  ...
  return (
    <div className="medico-layout">
      ...
      <div className="medico-main">
        <header className="medico-topbar">
          <SearchBar
            ...
            onChange={
              visao === "dashboard" ? setSearchDashboard : setSearchPacientes
            }
          />
                          ...
                          <button
                            ...
                            onClick={() => {
                              ...
                              if (p) handleGerarPdf(p, c);
                                ...
                                mostrarAlerta(
                                  "Dados do paciente não encontrados para gerar PDF",
                                  "erro",
                                );
                            }}
                          >
      ...
      {modalConsultarAberto && (
        <ModalConsultarPacientes
          onFechar={() => setModalConsultarAberto(false)}
        />
      )}
      {pacienteParaEditar && (
        <ModalEditarPaciente
